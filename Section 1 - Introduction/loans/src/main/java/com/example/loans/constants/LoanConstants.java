...
public final class LoanConstants {
    ...
    public static final String  MESSAGE_417_UPDATE= "Failed to process the Update request";
    public static final String  MESSAGE_417_DELETE= "Failed to process the Delete request";
}
